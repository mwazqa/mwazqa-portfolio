...
* **queries/** – Skrypty SQL (SELECT, JOIN, agregacje) wykorzystywane do walidacji zmian po akcjach w UI/API.
...
* **drivers/** – Browser binaries supported by the project.
...
### SQL / Database Testing
Backend validation and data integrity checks
